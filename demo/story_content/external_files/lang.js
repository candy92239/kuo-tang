export default {
  simp: {
    Ch3: {
      ...
      Lectin: {
        t1: "MASP attached to MBL/ficolin is activated and ready to act on C4 to break it into 2 parts.",
        t2: "C4 broke into C4a and C4b, which C4b attaches to the bacteria.",
        t3: "C2 broke into C2a and C2b by MASP too, leaving C2a attached to C4.",
        t4: "C4b2a breaks C3 into C3a and C3b, which C3b tags the bacteria to make it recognizable for our immune system.",
      },
      Clas: {
        t1: "A part (C1r and C1s) of C1 is activated and ready to act on C4.",
        t2: "C4 broke into C4a and C4b, which C4b attaches to the bacteria.",
        t3: "C2 broke into C2a and C2b by C1 too, leaving C2a attached to C4.",
        t4: "C4b2a breaks C3 into C3a and C3b, which C3b tags the bacteria to make it recognizable for our immune system.",
      },
      Alt: {
  ...
  norm: {
    Ch3: {
      ...
      Lectin: {
        t1: "MASP-1 attached to MBL/ficolin is activated and went through a conformational change that activates MASP-2.",
        t2: "MASP-2 cleaves C4 into C4a and C4b, which C4b attaches to pathogen surface.",
        t3: "MASP-2 cleaves C2 into C2a and C2b, leaving C2a attached to C4.",
        t4: "C4b2a is a C3 convertase that cleaves C3 into C3a and C3b, which C3b binds to pathogen surface and acts as an opsonin.",
      },
      Clas: {
        t1: "C1r in the C1 complex is activated and cleaves to activates C1s.",
        t2: "C1s cleaves C4 into C4a and C4b, which C4b attaches to pathogen surface.",
        t3: "C1s cleaves C2 into C2a and C2b, leaving C2a attached to C4.",
        t4: "C4b2a is a C3 convertase that cleaves C3 into C3a and C3b, which C3b binds to pathogen surface and acts as an opsonin.",
      },
      Alt: {
